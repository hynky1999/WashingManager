...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Auth.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("App.Auth.Utils.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.Borrow", b =>
                {
            ...
            modelBuilder.Entity("App.Data.Models.BorrowableEntity", b =>
                {
                    b.Property<int>("BorrowableEntityID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.BorrowableEntityUsage<App.Data.Models.DryingRoom>", b =>
                {
            ...
            modelBuilder.Entity("App.Data.Models.BorrowableEntityUsage<App.Data.Models.WashingMachine>", b =>
                {
                    b.Property<int>("DayId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.BorrowPerson", b =>
                {
                    b.Property<int>("BorrowPersonID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.Location", b =>
                {
                    b.Property<int>("LocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.Manual", b =>
                {
            ...
            modelBuilder.Entity("App.Data.Models.Reservation", b =>
                {
                    b.Property<int>("ReservationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Data.Models.DryingRoom", b =>
                {
                    b.HasBaseType("App.Data.Models.BorrowableEntity");

                    b.HasDiscriminator().HasValue("DryingRoom");
                });

            modelBuilder.Entity("App.Data.Models.WashingMachine", b =>
                {
                    b.HasBaseType("App.Data.Models.BorrowableEntity");
            ...
            modelBuilder.Entity("App.Data.Models.Borrow", b =>
                {
                    b.HasOne("App.Data.Models.BorrowPerson", "BorrowPerson")
                        .WithMany()
                        .HasForeignKey("BorrowPersonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Data.Models.BorrowableEntity", "BorrowableEntity")
                        .WithMany()
                        .HasForeignKey("BorrowableEntityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Data.Models.Reservation", "Reservation")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Data.Models.BorrowableEntity", b =>
                {
                    b.HasOne("App.Data.Models.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Data.Models.BorrowPerson", b =>
                {
                    b.HasOne("App.Auth.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("App.Auth.Utils.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("App.Auth.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Data.Models.WashingMachine", b =>
                {
                    b.HasOne("App.Data.Models.Manual", "Manual")
                        .WithMany()
